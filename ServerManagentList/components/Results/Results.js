...
const Results = props => {
  const { className, page, size, order, orderBy, onRequestSort, onRequestPagination, isLoading, servers, numberOfElements, totalPages, fetchPersons, ...rest } = props;
  ...
  return (
    ...
    >
      <Card>
        <TableToolbar title="Todos os servidores" numSelected={selectedServers.length} />
        <Divider />
                    ...
                    >
                      ...
                      <TableCell>
                        <div className={classes.nameCell}>
                          ...
                          >
                            {getInitials(server.name + ' ' + server.lastName)}
                          </Avatar>
                          <div>
                            {server.name}
